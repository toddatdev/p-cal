...
function src_default(Alpine) {
  ...
  Alpine.magic("focus", (el) => {
    ...
    return {
      ...
      focusable(el2) {
        return (0,tabbable__WEBPACK_IMPORTED_MODULE_0__.isFocusable)(el2);
      },
      previouslyFocused() {
        return lastFocused;
      },
      ...
      focusables() {
        if (Array.isArray(within))
          return within;
        return (0,tabbable__WEBPACK_IMPORTED_MODULE_0__.focusable)(within, { displayCheck: "none" });
      },
      all() {
  ...
  Alpine.directive("trap", Alpine.skipDuringClone(
    (el, { expression, modifiers }, { effect, evaluateLater, cleanup }) => {
      ...
      let trap = (0,focus_trap__WEBPACK_IMPORTED_MODULE_1__.createFocusTrap)(el, options);
      let undoInert = () => {
      };
